Pod::Spec.new do |s|
  ...
  s.name             = 'TikiSdkDebug'
  s.version          = '2.1.8'
  s.summary          = 'TIKI SDK (iOS) - Consumer Data Licensing - Debug version'
  s.description      = '<<-DESC
  Use this pod to run your project in a simulator. 
  
  The TIKI SDK for iOS makes it easy to add consumer data licensing to your iOS applications. 
  It is the client-side component that your users will interact with to accept (or decline) data licensing offers.
                        DESC'
