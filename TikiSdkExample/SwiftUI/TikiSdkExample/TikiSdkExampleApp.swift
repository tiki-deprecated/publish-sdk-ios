...
struct TikiSdkExampleApp: App {
    ...
    var body: some Scene {
        WindowGroup {
                ...
                }.presentTikiOffer(show: isShowingOfferPrompt)
        }
    }
}

struct PresentTikiOffer: ViewModifier {
...
public extension View {
    func presentTikiOffer(show: Bool) -> some View {
        modifier(PresentTikiOffer(show: show))
    }
}
